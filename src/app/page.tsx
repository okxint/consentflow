...
function WhatsAppDemo() {
  ...
  const messages: Msg[] = [
    ...
    { from: "bot", text: "⚠️ Based on comorbidities, these complications may apply.\nSelect:", checks: [
      { label: "BP fluctuations", checked: true },
      { label: "Higher bleeding risk", checked: true },
      { label: "Difficult airway", checked: false },
      { label: "DVT risk", checked: true },
      { label: "Wound dehiscence", checked: false },
    ] },
    { from: "staff", text: "✅ 3 additional complications selected" },
    { from: "bot", text: "Patient phone number?" },
