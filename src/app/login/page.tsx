...
import { FileText, MapPin, Shield, ChevronRight, LogIn, Mail, Lock } from "lucide-react";
          ...
          {step === 0 && (
            <div>
              ...
              <p className="text-sm text-[var(--color-text-secondary)] text-center mb-8">
                Sign in to your ConsentFlow account
              </p>
              ...
              <button
                ...
                disabled={signingIn}
                className="w-full bg-white border border-gray-300 text-gray-700 py-3 rounded-full font-medium text-sm hover:bg-gray-50 disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-3 transition-colors"
              >
              ...
              <p className="text-center text-sm text-[var(--color-muted)] mt-6">
                ...
                <span className="text-[var(--color-text-secondary)] font-medium">Contact your hospital admin</span>
              </p>
            </div>
          )}
